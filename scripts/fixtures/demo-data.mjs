...
export function businessFixture(firebaseUids) {
  ...
  const invoices = [
    { id: "DEMO-INV-001", transaction: { id: "DEMO-TX-001" }, vendor: "Quincaillerie Démo", invoiceNumber: "DEMO-FACT-001", invoiceDate: "2026-08-10", subtotalCents: "10000", tpsCents: "500", tvqCents: "998", totalCents: "11498", reviewStatus: "TO_VERIFY", storageFolder: "receipts/demo/DEMO-INV-001", createdBy: { id: "DEMO-USER-WORKER" } },
    { id: "DEMO-INV-002", transaction: { id: "DEMO-TX-002" }, vendor: "Station Démo", invoiceNumber: "DEMO-FACT-002", invoiceDate: "2026-08-11", subtotalCents: "8000", tpsCents: "400", tvqCents: "798", totalCents: "9198", reviewStatus: "VALIDATED", storageFolder: "receipts/demo/DEMO-INV-002", createdBy: { id: "DEMO-USER-WORKER" } },
  ];
  const invoicePhotos = [
