...
export async function verifyInvoiceIdempotence() {
  ...
  try {
    ...
    const photosAfterAuto = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const photosAfterRetry = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const invoicesAfterMismatch = await dataConnect.executeQuery("AdminListInvoices");
    const transactionsAfterMismatch = await dataConnect.executeQuery("ListExpenseTransactions");
    const photosAfterMismatch = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const kimPhotos = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const kimPhotosAfterReplay = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const humanMismatchInvoices = await dataConnect.executeQuery("AdminListInvoices");
    const humanMismatchTransactions = await dataConnect.executeQuery("ListExpenseTransactions");
    const humanMismatchPhotos = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const humanVsAutoInvoices = await dataConnect.executeQuery("AdminListInvoices");
    const humanVsAutoTransactions = await dataConnect.executeQuery("ListExpenseTransactions");
    const humanVsAutoPhotos = await dataConnect.executeQuery("AdminListInvoicePhotos");
    ...
    const finalIntakes = await dataConnect.executeQuery("ListInvoiceIntakes");
    const finalInvoices = await dataConnect.executeQuery("AdminListInvoices");
    const finalPhotos = await dataConnect.executeQuery("AdminListInvoicePhotos");
    const finalTransactions = await dataConnect.executeQuery("ListExpenseTransactions");
    const counters = {
