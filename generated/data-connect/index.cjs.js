...
const adminRecordArchivePurgeRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.adminRecordArchivePurgeRef = adminRecordArchivePurgeRef;

exports.adminRecordArchivePurge = function adminRecordArchivePurge(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const adminUpsertUserProfileWithAuditRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.adminUpsertUserProfileWithAuditRef = adminUpsertUserProfileWithAuditRef;

exports.adminUpsertUserProfileWithAudit = function adminUpsertUserProfileWithAudit(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(adminUpsertUserProfileWithAuditRef(dcInstance, inputVars));
}
;

const adminRecordUserAuditRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'AdminRecordUserAudit', inputVars);
}
adminRecordUserAuditRef.operationName = 'AdminRecordUserAudit';
exports.adminRecordUserAuditRef = adminRecordUserAuditRef;

exports.adminRecordUserAudit = function adminRecordUserAudit(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const finalizeCreditCardStatementImportRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.finalizeCreditCardStatementImportRef = finalizeCreditCardStatementImportRef;

exports.finalizeCreditCardStatementImport = function finalizeCreditCardStatementImport(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const retryInvoiceIntakeAiReviewV2Ref = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.retryInvoiceIntakeAiReviewV2Ref = retryInvoiceIntakeAiReviewV2Ref;

exports.retryInvoiceIntakeAiReviewV2 = function retryInvoiceIntakeAiReviewV2(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
